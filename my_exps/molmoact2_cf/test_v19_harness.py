...
def test_phase_probe_row_is_complete_skips_crash_junk() -> None:
    ...
    assert v19_harness.isolated_rollout_timeout_sec(500) >= 900.0
...
def test_launch_script_syntax_and_phase_probe() -> None:
    ...
    assert 'V19_PHASE_ROUNDS="${V19_PHASE_ROUNDS:-12}"' in body
    ...
    assert 'RLT_EGL_PER_GPU="${RLT_EGL_PER_GPU:-1}"' in body
    assert (
