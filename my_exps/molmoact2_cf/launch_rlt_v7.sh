#!/usr/bin/env bash
# Launch the 24-worker MolmoAct2 RLT-CF v7 (normalized explore + stronger ranking).
...
echo "[launch $(date -Is)] starting RLT-CF v7 (normalized explore + ranking)"
...
# MolmoAct2 RLT-CF v7 (normalized explore + ranking)
